        ...
        layui.use(['table'], function() {
            ...
            var tableIns = table.render({
                ...
                cols : [[
                    ...
                    {field: 'amount', title: '原金额', align:'center'},
                    {field: 'nowamount', title: '现金额', align:'center'},
                    {field: 'user_id', title: '用户', align:'center',templet:function(d){
                        return  d.email;
                    }},
                    {field: 'address_id', title: '地址', align:'center',templet:function(d){
                        return  d.addr;
                    }},                  
                    ...
                    {field: '', title: '功能一', align:'center',templet:function(d){
                    	if(d.status==1)
                    		return "<button class='layui-btn layui-btn-normal' onclick='openwina("+d.id+")' >发货</button>";
                    	if(d.status==4)
                    		return "<button class='layui-btn layui-btn-normal' onclick='openwin("+d.id+")' >取消</button>";
                    	return ""
                    }},
                ]]
            });
